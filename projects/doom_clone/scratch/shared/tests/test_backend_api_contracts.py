...
def load_app():
    ...
    spec = importlib.util.spec_from_file_location("backend_api_contracts", str(base_path))
...
def test_create_user_success_and_duplicate(client):
    tok = {"Authorization": "Bearer secrettoken"}
...
def test_create_user_missing_required_fields_422(client):
    tok = {"Authorization": "Bearer secrettoken"}
    # Missing 'name' field triggers validation error (422)
